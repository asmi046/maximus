            ...
            <div class="treatment-stages__grid">
                ...
                <article class="stage-card stage-card--odd">
                    ...
                    <p>Поддержание долгосрочной ремиссии. Включает регулярные поддерживающие консультации и участие в
                        эксклюзивных группах нашего центра. Рекомендуемый график — 1-2 встречи в месяц с возможностью
    ...
    <section id="faq-section" class="faq-section">
        <div class="container">
            ...
            <details>
                ...
                <div class="response">
                    Существует три рабочих решения: 1) Лечение с мотивацией «на месте» — пациент приезжает в центр,
            ...
            <details>
                <summary>Почему в других центрах не вылечили, а у Вас вылечат?</summary>
                <div class="response">
            ...
            <details>
                ...
                <div class="response">
                    Да, наш центр работает строго на законных основаниях. У нас имеется действующая государственная
            ...
            <div class="text_styles methodology__content">
                ...
                <ul>
                    <li>
                        ...
                        Пациент приезжает в центр, даже без твёрдой решимости. Наши
